...
echo
echo "3️⃣  Running appdmg to create ChunkerBatchConverter.dmg..."
appdmg ChunkerBatchConverter.json ChunkerBatchConverter.dmg
if [ $? -ne 0 ]; then
